...
<div align="center" style="
  background: linear-gradient(135deg, #E8F5F0 0%, #F8F3E8 100%);
  padding: 22px 18px;
  border-radius: 12px;
  font-size: 20px;
...
- (*Arxiv'25*) TheraMind: A Strategic and Adaptive Agent for Longitudinal Psychological Counseling [[📝 Paper](https://arxiv.org/abs/2510.25758)] 
...
| PsyChatbot | 2024.7 || A large-scale cleaned Chinese psychological counseling QA dataset |
| SimPsyDial | 2024.8 || A dataset for simulating counselor-client dialogues using LLMs, focusing on mental health support |
| Cactus | 2024.10 || A large-scale dataset of CBT-based multi-turn psychological counseling conversations |
| SMILE | 2024.10 || A large-scale, diverse multi-turn dialogue dataset for mental health support |
| MDD-5k | 2024.12 || An annotated Chinese Mental Disorder Diagnostic Conversation Dataset |
| PsyDTCorpus | 2024.12 || A REBT-based dataset of Chinese psychological counseling conversations |
| STAMPsy | 2024.12 || A Chinese multi-turn, spatiotemporal-aware, mixed-type psychological counseling dataset |
| HamRaz | 2025.2 || A culture-based Persian psychotherapy conversation dataset for person-centered therapy |
| KMI | 2025.2 || A comprehensive dataset of Korean Motivational Interviewing dialogues |
| SYNTHEMPATHY | 2025.2 || A large, LLM-synthesized dataset of single-round empathetic conversations |
| Psy-Insight | 2025.3 || A bilingual counseling dataset with multi-turn dialogues and rich explainable annotations |
| Crisp | 2025.4 || A large-scale bilingual conversational datasets that support conversational cognitive reconstruction |
| OpenR1-Psy | 2025.5 || A mental health dialogue dataset that supports diagnostic reasoning and therapeutic reasoning |
| KokoroChat | 2025.6 || A psychological counseling dialogue dataset with person role-playing and detailed client feedback |
| MusPsy | 2025.6 || A multi-session cognitive behavioral therapy counseling dialogue dataset |
| PsyDial | 2025.7 || A privacy-preserving Chinese counseling dialogue dataset with long multi-turn conversations |
| CPsDD | 2025.7 || A comprehensive large-scale dataset of Chinese psychological support conversations |
| StimuliQA | 2025.8 || An expert-annotated psychological reasoning dataset of real-life narratives in QA format |
| Psyche-R1 | 2025.8 || A Chinese psychology QA and dialogue dataset for reasoning and empathy |
| DiaCBT | 2025.9 || A CBT counseling dialogue dataset containing cognitive conceptualization diagram |
| MAGneT | 2025.9 || A psychological counseling dialogue dataset generated by a multi-agent framework |
